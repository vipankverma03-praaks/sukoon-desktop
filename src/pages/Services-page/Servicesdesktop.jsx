...
const Content = {
  ...
  items:[
    ...
    },
    {
      ...
      points: '<ul class="dot-list"><li>An independent Psychiatrist</li><li>A personal clinical Psychologist assigned to you</li><li>One nurse dedicated to address your needs</li><li>24*7 on-duty doctor for any medical concerns</li><li>ASpecialized care via a team of Art based therapist, nutritionists, physiotherapists, and yoga instructor</li></ul>',
    },
      {
  ...
  items:[
    ...
    },
    {
      para: `Our ICUs minimise the risk of self-harm and injury. They are the first of its kind in India with: `,
        points: '<ul class="dot-list"><li>Soft padded walls</li><li>Padded furniture</li><li>One nurse dedicated to address your needs</li><li>24*7 dedicated nurse </li><li>24*7 supervision and monitoring</li><li>Accessibility friendly (handrails, two-way incline hospital bed with rails)</li></ul>',
    },
  ]
};
  ...
  items:[
    {
      para: `At Sukoon, our highly skilled team of addiction experts consists of Psychiatrists, clinical Psychologists, counsellors and arts based therapists. A comprehensive drug recovery program ensures that we address all aspects of drug addiction such as biological dependence, psychological challenges, unhelpful behavioural patterns and social support. We follow an integrated approach to management and offer de-addiction in various substances:`,
        ...
        points: '<ul class="dot-list pb-2"><li>Tobacco dependence</li><li>Cannabis (Marijuana) dependence</li><li>Inhalant dependence (glue sniffing, petrol, paint solvents)</li><li>Drug dependence (cocaine, heroin, MDMA)</li><li>Dependence on stimulants like amphetamine, caffeine etc.</li></ul>',
    },
    {
      title: 'Our Approach',
      para: `We ensure round the clock assistance for all your drug recovery challenges and our treatment involves: `,
        
        points: '<ul class="number-list"><li><strong>Detoxification</strong>: Management of the psychological as well as physical withdrawal symptoms under the supervision of a team consisting of a Psychiatrist, a Clinical Psychologist and an Art based Therapist.</li><li><strong>Deaddiction</strong>: Assessment and enhancement of the motivation for consumption with individuals as well as group therapy sessions.</li><li><strong>Relapse prevention</strong>: Targeted therapy sessions for improving coping response  and handling high risk situations.</li><li><strong>Continued care/ Rehabilitation</strong>: Regularly planned individual, group and family therapy sessions aiming at prevention of relapse.</li></ul>',
  ...
  items:[
    {
      ...
      points: '<ul class="dot-list pb-2 mt-2"><li>Internet gaming addiction</li><li>Mobile addiction</li><li>Gambling disorder etc.</li><li>Pornography addiction</li><li>Sex addiction</li></ul>',
  ...
  items:[
    {
      ...
      points: '<ul class="dot-list pb-2 mt-2"><li>Individuals with mental health conditions and physical disabilities</li><li>Elderly patients, and others.</li></ul>',
    ...
    },
    {
      ...
      para: `Our team aims at providing effective pharmacological and psychological interventions for various mental health conditions. The treatment includes various assessments to prepare a tailor-made management plan in keeping with the patients specific needs. We also prioritize mental health care of the family and the caregivers.`,
        ...
        points:'<p><i>Treatment objectives include reintegration into society, enhancing social skills, developing interpersonal skill development and fostering independent living.</i><p>'
    },
  ]
};
  ...
  items:[
    {
      ...
      points: '<ul class="dot-list pb-2 mt-2"><li>Organic conditions: Dementia in Alzheimer’s disease, vascular dementia, dementia in other diseases etc. </li><li>Stress related disorders: Acute stress reaction, adjustment disorder, somatoform disorders etc.</li><li>Mood disorders: Depression, dysthymia, generalised anxiety, panic disorder etc.</li><li>Psychiatric difficulties arising out of physical ailments, conditions, and ambulatory concerns</li><li>Empty nest syndrome and migration of young family members which can cause loneliness </li></ul>',
    ...
    },
    {
      ...
      para: `Sukoon understands the challenges of aging at a biological, psychological and social level and addresses them by providing robust and holistic treatments. Our management plans include both pharmacological as well as psychological therapy (Individual and group). Our facility is equipped for specialised requirements of the elderly such as:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>Dedicated floor for geriatric age group</li><li>Daily physiotherapy sessions</li><li>Infrastructure which is geriatric friendly</li><li>Lift access to each floor including the basement</li></ul>',
    },
      {
  ...
  items:[
    ...
    },
    {
      ...
      para: `At Sukoon, we take therapist-patient confidentiality seriously. Throughout our facility we have taken measures to ensure that your conversations remain private. Our therapy rooms are equipped with the following amenities:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>Comfortable seating (sofas, high chairs - take your pick) </li><li>Spacious rooms with ample sunlight</li><li> White noise sound machines to prevent eavesdropping </li><li>Plants, plants, and more plants! </li></ul>',
    },
  ]
};
  ...
  items:[
    {
      ...
      points: '<ul class="dot-list"><li><strong>Psychiatric disorders</strong>: Depression, Anxiety, OCD, Psychosis, Bipolar disorder etc.</li><li><strong>Behavioral disorders</strong>: Aggressive outbursts, disregarding authority etc.</li><li><strong>Developmental disorders</strong>: ADHD, ADD, individuals with special needs etc.<li>Trauma and abuse</li><li>Anger Management</li></ul>',
        
    },
    {
      para: `For individuals, groups, and corporates we use Art Based Therapy to address the following: `,
        
        points: '<ul class="dot-list pb-2 mt-2"><li>Confidence and motivation building </li><li>Leadership skills</li><li>Stress management </li><li>Assertiveness</li><li>Interpersonal skills and building effective communication patterns</li><li>Coping with serious or chronic illness </li><li>Facilitating support groups</li></ul>',
    },
      {
      title: 'Our Approach',
      para: `Our priority is to help facilitate a patient's expression. For this we use various mediums such as visual arts - drawing, painting, clay, crafts, pottery, sculpture, 3-D modelling, music, storytelling, creative writing, movement, and dance. Every patient is unique and hence, we personalise treatment as per their comfort, and needs. At Sukoon our aim is to create a safe, non-judgemental, and contained space with all our patients via an independent art therapy studio that boasts of:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>A spacious glass room on the terrace</li><li>A lush green terrace garden for outdoor activities</li><li>Variety of art materials (paints, potter’s clay, textile etc – take your pick! )</li><li>Private and confidential storage space</li></ul>',
    },
      {
  ...
  items:[
    {
      ...
      points: '<p>At Sukoon we use world class rTMS machines to provide relief from psychiatric and organic conditions such as:</p>',
  ...
  items:[
    {
      ...
      para: `At Sukoon, we are committed to creating a safe therapeutic space that facilitates rapport building and self-disclosure and hence Therapist-Patient confidentiality is our top most priority. Throughout our facility we have taken measures to ensure that your conversations remain private. Our therapy rooms are equipped with the following amenities:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>Comfortable couch</li><li>Spacious rooms with ample sunlight</li><li>White noise sound machines to prevent eavesdropping</li><li>Plants, plants, and more plants!</li></ul>',
    },
      {
  ...
  items:[
    {
      ...
      points: '<p>Occupational therapy aims to build and strengthen cognitive, sensory and motor functioning and has been proven to be beneficial for:</p>',
        
    },
      {
          points: '<ul class="dot-list pb-2 mt-2"><li>Aiding children with developmental disorders </li><li>Modifying tasks and simplifying learning for children with special needs </li><li>Reducing the impact of arthritis</li><li>Improving movement range for those with motor constraints</li><li></li>Boosting memory and cognitive skills<li>Coping with chronic pain</li></ul>',
      },
      ...
      para: `At Sukoon, the occupational therapists address barriers to optimal functioning through individualized evaluations and tailored interventions that focus on:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>Enhancing existing skills</li><li>Creating opportunities</li><li>Remediating or restoring skills</li><li>Modifying or adapting the environment or activity and preventing relapse</li></ul>',
    },
      {
  ...
  items:[
    {
     ...
     points: '<ul class="dot-list pb-2 mt-2"><li>Depression and anxiety: Low mood, feeling of helplessness, hopelessness and worthlessness etc.</li><li>Psychological concerns : Lack of motivation; uncertainty and negativity in life etc. </li><li>Biological concerns : Sleep disturbances, fertility problems etc.</li><li>Body image concerns due to chemotherapy</li><li>Side effect of medication </li><li>End of life counselling</li></ul>',
      ...
      para: `Our team of Psychiatrists, along with Clinical Psychologists, creates a personalized treatment plans that involve:`,
        ...
        points: '<ul class="dot-list pb-2 mt-2"><li>Understanding psycho-oncology</li><li>Comprehensive psychosocial assessment for cancer patients</li><li>Interventions to enhance coping skills in cancer</li><li>Application of a range of psychological interventions</li><li>Improving communication and interpersonal skills in cancer care</li></ul>',
    },
      {
...
const RightContainer = ({Content}) =>{
  ...
  let list = Content.items.map(list=>{
    return(
      ...
      <div className="content" dangerouslySetInnerHTML={{__html: list.points}}></div>
      </li>
    )
  });
